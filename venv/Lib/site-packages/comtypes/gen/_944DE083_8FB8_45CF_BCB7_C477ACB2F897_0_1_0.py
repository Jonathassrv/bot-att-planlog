...
__all__ = [
    ...
    'UIA_IsWindowPatternAvailablePropertyId', 'TextEditChangeType',
    'UIA_FullDescriptionPropertyId',
    'UIA_OptimizeForVisualContentPropertyId', 'UIA_TextEditPatternId',
    'UIA_StylesFillColorPropertyId', 'AnnotationType_Comment',
    'IUIAutomationPropertyCondition', 'UIA_VisualEffectsPropertyId',
    ...
    'UIA_StylesPatternId', 'AnnotationType_EditingLockedChange',
    'TextUnit', 'IUIAutomationSpreadsheetPattern', 'StyleId_Heading8',
    'TreeTraversalOptions_LastToFirstOrder',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_SayAsInterpretAsMetadataId', 'StyleId_Emphasis',
    'NavigateDirection_Parent',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_Drag_DragStartEventId', 'WindowVisualState_Minimized',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_ListItemControlTypeId', 'UIA_GridItemRowPropertyId',
    'TextUnit_Format', 'UIA_CulturePropertyId',
    'WindowInteractionState_Closing', 'UIA_TextChildPatternId',
    'UIA_UnderlineStyleAttributeId', 'StyleId_Normal',
    'UIA_ProcessIdPropertyId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'UIA_DockPatternId', 'IUIAutomationAnnotationPattern',
    'UIA_Selection2ItemCountPropertyId',
    'IUIAutomationCustomNavigationPattern',
    'UIA_TitleBarControlTypeId', 'StructureChangeType',
    'UIA_IsInvokePatternAvailablePropertyId', 'DockPosition_Bottom',
    'ZoomUnit_SmallIncrement', 'UIA_IsReadOnlyAttributeId',
    'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_ActiveTextPositionChangedEventId',
    'AnnotationType_SpellingError', 'IUIAutomationElement2',
    'TreeTraversalOptions_Default', 'UIA_HeaderControlTypeId',
    'UIA_NativeWindowHandlePropertyId', 'HeadingLevel3',
    'UIA_LegacyIAccessibleNamePropertyId', 'Polite',
    'IUIAutomationWindowPattern', 'IUIAutomation4',
    'UIA_CaretPositionAttributeId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_StylesFillPatternColorPropertyId',
    'UIA_IsDataValidForFormPropertyId', 'DockPosition_Top',
    'UIA_DataGridControlTypeId', 'UIA_AnnotationPatternId',
    'IUIAutomationSpreadsheetItemPattern',
    'NavigateDirection_PreviousSibling',
    'UIA_IsDockPatternAvailablePropertyId',
    'UIA_CenterPointPropertyId', 'UIA_ValueValuePropertyId',
    'DockPosition', 'RowOrColumnMajor_ColumnMajor',
    'UIA_SizePropertyId', 'RowOrColumnMajor_Indeterminate',
    'UIA_CapStyleAttributeId', 'UIA_MultipleViewPatternId',
    'TextUnit_Character', 'IUIAutomationVirtualizedItemPattern',
    'IUIAutomationTextPattern', 'UIA_Window_WindowOpenedEventId',
    'UIA_AriaRolePropertyId', 'StyleId_Heading1',
    'UIA_ScrollBarControlTypeId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'NotificationKind_ActionAborted',
    'IUIAutomationMultipleViewPattern', 'ProviderOptions',
    'CoalesceEventsOptions_Enabled', 'StyleId_Heading4',
    'ScrollAmount_LargeIncrement', 'UIA_ControlTypePropertyId',
    'IUIAutomationElement5',
    'NotificationProcessing_ImportantMostRecent',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'SupportedTextSelection', 'UIA_StylesStyleNamePropertyId',
    'UIA_CalendarControlTypeId', 'TextEditChangeType_AutoCorrect',
    'NavigateDirection', 'AnnotationType_InsertionChange',
    'UIA_ValuePatternId', 'IUIAutomationProxyFactoryEntry',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_GridItemContainingGridPropertyId', 'UIA_SystemAlertEventId',
    'UIA_ImageControlTypeId', 'NotificationKind',
    ...
    'UIA_ValueIsReadOnlyPropertyId', 'IUIAutomationEventHandler',
    'IUIAutomationElement4', 'SupportedTextSelection_Single',
    'UIA_SeparatorControlTypeId', 'UIA_CheckBoxControlTypeId',
    'UIA_FlowsFromPropertyId',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_Drag_DragCancelEventId', 'TreeTraversalOptions',
    'SynchronizedInputType_RightMouseUp', 'AnnotationType_Footer',
    ...
    'UIA_TableItemPatternId', 'ZoomUnit_SmallDecrement',
    'UIA_TabControlTypeId', 'UIA_ProgressBarControlTypeId',
    'UIA_CustomLandmarkTypeId',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'UIA_StylesShapePropertyId', 'IUIAutomationDockPattern',
    'UIA_ToolBarControlTypeId', 'IUIAutomationBoolCondition',
    'UIA_IndentationTrailingAttributeId',
    'UIA_WindowCanMinimizePropertyId',
    'UIA_SynchronizedInputPatternId', 'UIA_ChangesEventId',
    'UIA_ClickablePointPropertyId', 'UIA_AutomationIdPropertyId',
    'StyleId_Heading7', 'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_Text_TextSelectionChangedEventId', 'UIA_TablePatternId',
    'ScrollAmount_SmallIncrement',
    'SynchronizedInputType_LeftMouseUp', 'HeadingLevel8',
    'NotificationProcessing_All',
    'IUIAutomationNotificationEventHandler',
    'ToggleState_Indeterminate', 'UIA_ClassNamePropertyId',
    'HeadingLevel4', 'WindowInteractionState',
    'UIA_SpinnerControlTypeId', 'UIA_MarginLeadingAttributeId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'ProviderOptions_ServerSideProvider',
    'UIA_RangeValueValuePropertyId',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'ScrollAmount_SmallDecrement', 'AnnotationType_Unknown',
    'UiaChangeInfo', 'UIA_LocalizedControlTypePropertyId',
    'IUIAutomationTextPattern2', 'OrientationType_Vertical',
    'UIA_EditControlTypeId', 'UIA_InvokePatternId',
    'UIA_ScrollItemPatternId', 'DockPosition_Right',
    'UIA_BeforeParagraphSpacingAttributeId', 'StyleId_Heading9',
    'UIA_SearchLandmarkTypeId', 'UIA_TableControlTypeId',
    'UIA_MenuModeEndEventId', 'TextEditChangeType_None',
    'TextUnit_Word', 'UIA_ComboBoxControlTypeId',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_DropTarget_DragLeaveEventId', 'TextUnit_Paragraph',
    'StyleId_Heading5', 'ZoomUnit_LargeDecrement',
    'UIA_HasKeyboardFocusPropertyId', 'UIA_ItemContainerPatternId',
    'SynchronizedInputType_KeyDown', 'IUIAutomationDropTargetPattern',
    'ExpandCollapseState', 'IUIAutomationElement',
    'IUIAutomationItemContainerPattern', 'UIA_DocumentControlTypeId',
    'ZoomUnit', 'AutomationElementMode_None', 'AutomationElementMode',
    'IUIAutomation3', 'UIA_LiveSettingPropertyId',
    'AnnotationType_Mathematics',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'AnnotationType_Endnote', 'IUIAutomationNotCondition',
    'ExpandCollapseState_PartiallyExpanded',
    'UIA_MarginBottomAttributeId', 'UIA_HyperlinkControlTypeId',
    'AnnotationType_Highlighted', 'UIA_CustomControlTypeId',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_BulletStyleAttributeId', 'ProviderOptions_UseComThreading',
    'IUIAutomation', 'CoalesceEventsOptions_Disabled',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'IUIAutomationFocusChangedEventHandler', 'IUIAutomationTextRange',
    'UIA_InputReachedTargetEventId', 'UIA_HeadingLevelPropertyId',
    'UIA_IsSuperscriptAttributeId', 'HeadingLevel2',
    'UIA_LevelPropertyId', 'StyleId_Heading3',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_BackgroundColorAttributeId', 'UIA_IsDialogPropertyId',
    'UIA_DragDropEffectPropertyId', 'UIA_TableRowHeadersPropertyId',
    'UIA_IsTablePatternAvailablePropertyId',
    'IRawElementProviderSimple', 'TreeScope_None',
    'SupportedTextSelection_None', 'UIA_GridItemColumnSpanPropertyId',
    ...
    'NotificationKind_Other', 'UIA_Transform2ZoomMinimumPropertyId',
    'UIA_Window_WindowClosedEventId', 'UIA_ItemTypePropertyId',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_IsSelectionPatternAvailablePropertyId', 'TreeScope_Element',
    'UIA_DescribedByPropertyId', 'UIA_AnnotationTypesPropertyId',
    'IUIAutomationDragPattern', 'AnnotationType_Footnote',
    'ScrollAmount_NoAmount', 'IUIAutomationStylesPattern',
    'AnnotationType_Author', 'IUIAutomationProxyFactoryMapping',
    'UIA_LegacyIAccessibleRolePropertyId',
    'UIA_OutlineStylesAttributeId',
    'UIA_ProviderDescriptionPropertyId', 'UIA_FillTypePropertyId',
    'UIA_AcceleratorKeyPropertyId', 'UIA_StatusBarControlTypeId',
    ...
    'NavigateDirection_NextSibling', 'UIA_ToolTipControlTypeId',
    'AnnotationType_Header', 'UIA_SizeOfSetPropertyId',
    'TreeTraversalOptions_PostOrder', 'UIA_SelectionItemPatternId',
    'UIA_OverlineStyleAttributeId',
    'PropertyConditionFlags_IgnoreCase',
    'IUIAutomationTextEditPattern', 'UIA_CultureAttributeId',
    'UIA_StyleNameAttributeId', 'UIA_SayAsInterpretAsAttributeId',
    'NotificationKind_ItemAdded',
    'UIA_AutomationPropertyChangedEventId',
    'IUIAutomationSelectionPattern', 'UIA_UnderlineColorAttributeId',
    'UIA_NamePropertyId', 'AnnotationType_DeletionChange',
    'AnnotationType_ExternalChange', 'UIA_ToolTipOpenedEventId',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'IUIAutomationTogglePattern', 'UIA_HelpTextPropertyId',
    'IUIAutomationCacheRequest', 'UIA_TextPatternId',
    'UIA_AnnotationTargetPropertyId', 'UIA_HeaderItemControlTypeId',
    'HeadingLevel5', 'UIA_AnnotationObjectsAttributeId',
    'UIA_FlowsToPropertyId', 'IUIAutomationCondition',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'TextEditChangeType_AutoComplete',
    'SynchronizedInputType_RightMouseDown', 'UIA_SelectionPattern2Id',
    'UIA_FormLandmarkTypeId', 'UIA_SummaryChangeId',
    'AnnotationType_UnsyncedChange', 'IUIAutomationAndCondition',
    'UIA_ButtonControlTypeId', 'UIA_PaneControlTypeId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_Selection_InvalidatedEventId', 'IUIAutomationElement7',
    'SynchronizedInputType', 'TreeScope_Children',
    'UIA_DragGrabbedItemsPropertyId', 'UIA_FillColorPropertyId',
    ...
    'WindowInteractionState_Running', 'IUIAutomationElement3',
    'UIA_AnimationStyleAttributeId',
    'UIA_RangeValueMinimumPropertyId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'ProviderOptions_UseClientCoordinates',
    'AnnotationType_FormatChange', 'UIA_ToggleToggleStatePropertyId',
    'UIA_WindowIsModalPropertyId', 'UIA_LegacyIAccessiblePatternId',
    'UIA_GridItemPatternId', 'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_Transform2ZoomLevelPropertyId', 'TreeScope',
    'CUIAutomation8', 'IUIAutomationSelectionPattern2',
    'UIA_StyleIdAttributeId', 'UIA_IsKeyboardFocusablePropertyId',
    'UIA_IsContentElementPropertyId', 'UIA_RuntimeIdPropertyId',
    'UIA_SpreadsheetItemPatternId', 'UIA_TextControlTypeId',
    'UIA_WindowWindowVisualStatePropertyId',
    'ProviderOptions_HasNativeIAccessible', 'HeadingLevel1',
    'AnnotationType_ConflictingChange', 'StyleId_Heading6',
    'IUIAutomationTransformPattern', 'UIA_FontNameAttributeId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_DataItemControlTypeId', 'UIA_DropTarget_DroppedEventId',
    'StyleId_Heading2', 'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_AsyncContentLoadedEventId', 'UIA_TransformCanMovePropertyId',
    'UIA_RangeValueLargeChangePropertyId',
    'UIA_LegacyIAccessibleStatePropertyId', 'WindowVisualState',
    'UIA_ScrollPatternId', 'UIA_IsItalicAttributeId',
    'TextEditChangeType_Composition', 'UIA_ControllerForPropertyId',
    ...
    'IUIAutomationSelectionItemPattern', 'AnnotationType_MoveChange',
    'IUIAutomationEventHandlerGroup',
    'UIA_StylesFillPatternStylePropertyId',
    'UIA_TabItemControlTypeId', 'DockPosition_None',
    'UIA_AccessKeyPropertyId', 'IUIAutomationGridPattern',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_MenuModeStartEventId', 'ToggleState',
    'ZoomUnit_LargeIncrement', 'UIA_IndentationFirstLineAttributeId',
    'StyleId_Custom', 'UIA_MenuItemControlTypeId',
    'UIA_LandmarkTypePropertyId', 'IUIAutomationScrollItemPattern',
    'TreeScope_Descendants', 'UIA_IsTextPatternAvailablePropertyId',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_FrameworkIdPropertyId', 'SynchronizedInputType_KeyUp',
    'LiveSetting', 'DockPosition_Fill', 'TextUnit_Document',
    'SupportedTextSelection_Multiple', 'UIA_IsPasswordPropertyId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'NavigateDirection_FirstChild', 'UIA_GridPatternId',
    ...
    'UIA_IsHiddenAttributeId', 'UIA_TextPattern2Id',
    'ConnectionRecoveryBehaviorOptions', 'IUIAutomationTextRange2',
    'UIA_GroupControlTypeId', 'UIA_DropTarget_DragEnterEventId',
    'UIA_MainLandmarkTypeId', 'StructureChangeType_ChildrenBulkAdded',
    'UIA_LayoutInvalidatedEventId',
    'ProviderOptions_OverrideProvider', 'TextUnit_Line',
    'UIA_TransformCanResizePropertyId', 'UIA_TreeItemControlTypeId',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'IUIAutomationTablePattern',
    'UIA_IsScrollPatternAvailablePropertyId', 'ToggleState_Off',
    'NotificationProcessing_ImportantAll', 'StyleId_Subtitle',
    'UIA_Transform2ZoomMaximumPropertyId',
    'UIA_CustomNavigationPatternId', 'UIA_TransformPatternId',
    'IUIAutomationElementArray',
    'UIA_IsScrollItemPatternAvailablePropertyId', 'HeadingLevel9',
    'TextPatternRangeEndpoint_Start', 'UIA_CaretBidiModeAttributeId',
    'UIA_TreeControlTypeId', 'PropertyConditionFlags',
    'UIA_MenuClosedEventId', 'UIA_SelectionActiveEndAttributeId',
    'OrientationType_Horizontal', 'CoalesceEventsOptions',
    'NotificationKind_ActionCompleted',
    'UIA_AutomationFocusChangedEventId',
    'UIA_StylesStyleIdPropertyId',
    'AnnotationType_DataValidationError', 'ZoomUnit_NoAmount',
    'UIA_ObjectModelPatternId', 'UIA_InputReachedOtherElementEventId',
    'UIA_MarginTopAttributeId', 'UIA_TabsAttributeId',
    'TreeScope_Subtree', 'UIA_LinkAttributeId', 'ExtendedProperty',
    'UIA_IsActiveAttributeId', 'ToggleState_On',
    'AnnotationType_FormulaError', 'UIA_OutlineThicknessPropertyId',
    'UIA_OrientationPropertyId', 'IUIAutomation2',
    'IUIAutomationElement6', 'UIA_FontSizeAttributeId',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'UIA_NavigationLandmarkTypeId',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_DropTargetPatternId', 'IUIAutomationOrCondition',
    'IUIAutomationElement8', 'ScrollAmount',
    'UIA_ForegroundColorAttributeId', 'UIA_Text_TextChangedEventId',
    'UIA_LiveRegionChangedEventId', 'UIA_NotificationEventId',
    ...
    'UIA_GridItemRowSpanPropertyId', 'UIA_AnnotationAuthorPropertyId',
    'UIA_DockDockPositionPropertyId',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_ThumbControlTypeId', 'TreeScope_Parent',
    'UIA_IsOffscreenPropertyId', 'StyleId_BulletedList',
    'UIA_TogglePatternId', 'Off', 'IUIAutomation6', 'HeadingLevel7',
    ...
    'UIA_IsControlElementPropertyId', 'AnnotationType_TrackChanges',
    'IUIAutomationScrollPattern', 'HeadingLevel6',
    'TextEditChangeType_CompositionFinalized',
    'StructureChangeType_ChildrenReordered',
    'UIA_RadioButtonControlTypeId', 'UIA_RangeValueMaximumPropertyId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_OutlineColorPropertyId', 'IUIAutomationInvokePattern',
    'StyleId_Title', 'UIA_ExpandCollapsePatternId',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_IsSubscriptAttributeId', 'AnnotationType_GrammarError',
    'UIA_StrikethroughStyleAttributeId', 'NotificationProcessing',
    'OrientationType_None', 'UIA_GridRowCountPropertyId',
    'RowOrColumnMajor', 'UIA_DragDropEffectsPropertyId',
    ...
    'IUIAutomationTextRange3', 'IUIAutomationElement9',
    'AnnotationType_CircularReferenceError', 'Assertive',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_TransformPattern2Id', 'UIA_BoundingRectanglePropertyId',
    'UIA_ToolTipClosedEventId', 'UIA_TableRowOrColumnMajorPropertyId',
    'IUIAutomationExpandCollapsePattern',
    'IUIAutomationTextRangeArray',
    'NotificationProcessing_CurrentThenMostRecent',
    'IUIAutomationObjectModelPattern', 'UIA_GridItemColumnPropertyId',
    'UIA_LocalizedLandmarkTypePropertyId', 'CUIAutomation',
    'WindowVisualState_Normal', 'UIA_WindowControlTypeId',
    'UIA_Transform2CanZoomPropertyId', 'RowOrColumnMajor_RowMajor',
    'UIA_AnnotationDateTimePropertyId',
    'UIA_WindowIsTopmostPropertyId',
    'UIA_TableColumnHeadersPropertyId', 'UIA_WindowPatternId',
    'UIA_Drag_DragCompleteEventId', 'IUIAutomationTableItemPattern',
    'UIA_ScrollVerticalViewSizePropertyId', 'TextUnit_Page',
    'IUIAutomationSynchronizedInputPattern',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_SpreadsheetPatternId', 'HeadingLevel_None',
    'UIA_TransformCanRotatePropertyId', 'IUIAutomationProxyFactory',
    'UIA_LabeledByPropertyId', 'DockPosition_Left',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'SynchronizedInputType_LeftMouseDown',
    'UIA_StylesExtendedPropertiesPropertyId', 'UIA_MenuOpenedEventId',
    'AnnotationType_AdvancedProofingIssue',
    'TextPatternRangeEndpoint', 'UIA_SelectionPatternId',
    'UIA_GridColumnCountPropertyId', 'ExpandCollapseState_Expanded',
    'UIA_MenuBarControlTypeId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'NavigateDirection_LastChild',
    'UIA_IsValuePatternAvailablePropertyId', 'StyleId_NumberedList',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'ProviderOptions_NonClientAreaProvider', 'UIA_RotationPropertyId',
    'UIA_WindowCanMaximizePropertyId', 'TreeScope_Ancestors',
    'UIA_AriaPropertiesPropertyId', 'IUIAutomationGridItemPattern',
    'UIA_InputDiscardedEventId',
    'UIA_IsDragPatternAvailablePropertyId', 'StyleId_Quote',
    'ScrollAmount_LargeDecrement', 'StructureChangeType_ChildAdded'
]

_check_version('1.1.14', 1656114311.572817)
